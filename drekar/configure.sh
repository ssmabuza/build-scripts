...
TRILINOS_HOME="${HOME}/Software/drekar/Trilinos"

INSTALL_DIR="${HOME}/Software/drekar"
...
cmake \
      ...
      -D Drekar_ENABLE_ROL:BOOL=OFF \
      -D Trilinos_EXTRA_REPOSITORIES="DrekarBase" \
      -D PYTHON_EXECUTABLE:FILEPATH="${SOFTWARE}/anaconda3/bin/python" \
